...
function RouteComponent() {
  return (
    <div className="container m-auto p-8 bg-white/50 backdrop-blur-sm rounded-xl shadow-sm mt-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 auto-rows-min">
        ...
        <div className="flex justify-start items-start md:col-start-2 md:row-start-1">
          <img
            src="/main_title_sponsors/page/title-sponsor-2/gong-law-1.png"
            alt="Gong Law Business Card"
            className="w-full max-w-sm h-auto object-contain rounded-lg shadow-md"
          />
        </div>
        ...
        <div className="prose max-w-none md:col-span-2 md:row-start-2 md:col-start-1">
          <p className="text-md">
            Gong Law provides professional legal services with a focus on
            delivering results. Our experienced team is dedicated to guiding you
            through complex legal matters with clarity and confidence.
          </p>
          <p className="p-2 text-xs text-slate-400">
            Whether you need assistance with real estate, business law, or
            family matters, Gong Law is here to advocate for your best
            interests.
          </p>
        </div>

        {/* Column 3: More Pictures (Spans 2 rows) */}
        <div className="flex flex-col gap-2 md:col-start-3 md:row-start-1 md:row-span-2">
          <img
            src="/main_title_sponsors/page/title-sponsor-2/gong-law-2.png"
            alt="Gong Law Business Card"
            className="w-full max-w-sm h-auto object-contain rounded-lg shadow-md"
          />
        </div>
